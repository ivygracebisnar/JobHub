    ...
    <body>
        ...
        <div class="main--content">
            ...
            <div class="tabular--wrapper">
                <div class="table-container">
                    <table>
                        ...
                        <?php
                                ...
                                $result_count=mysqli_query($conn, "SELECT COUNT(*) as total_records FROM admin_activity_log WHERE user_id = '$user_id'");
                                $total_records = mysqli_fetch_array($result_count);
                                $total_records = $total_records['total_records'];
                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                $second_last = $total_no_of_pages - 1;

                                $sql = mysqli_query($conn, "SELECT * FROM admin_activity_log WHERE user_id = '$user_id' ORDER BY activity_timestamp DESC LIMIT $offset,$total_records_per_page");
                                $count =1;
                ...
                <a href="activitylog_users.php?type=user"><button style="background: rgb(86, 75, 133);color: #fff;padding: 7px 15px;border-radius: 5px;margin-bottom: 5px;cursor: pointer;">Users Activity Log</button></a>
            </div>
        </div>
