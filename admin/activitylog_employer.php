                ...
                <div class="table-container">
                    <table>
                        ...
                        <?php
                                ...
                                $result_count=mysqli_query($conn, "SELECT COUNT(*) as total_records FROM employers_activity_log");
                                $total_records = mysqli_fetch_array($result_count);
                                $total_records = $total_records['total_records'];
                                $total_no_of_pages = ceil($total_records / $total_records_per_page);
                                $second_last = $total_no_of_pages - 1;

                                $sql = mysqli_query($conn, "SELECT employers_activity_log.*, employers.emp_name AS employer_emp_name FROM employers_activity_log JOIN employers ON employers_activity_log.user_id = employers.id ORDER BY activity_timestamp DESC LIMIT $offset,$total_records_per_page");
                                $count =1;
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['employer_emp_name'];?></td>
